...
XTest = combineBins(XBins, indeces); 
LTest = combineBins(LBins, indeces); 
DTest = combineBins(DBins, indeces); 
...
W0 = rand(size(X, 2), numHidden)*2-1; % Initialize your weight matrix W 
V0 = rand(numHidden+1, length(unique(L)))*2-1; % Initialize your weight matrix V 
